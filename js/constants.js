...
const BALANCE_PROMPT =
	"Enter the balance you wish to bet, consider that each bet will be $100.";
const BALANCE_ALERT =
	"The balance must be greater than or equal to 100, please re-enter the balance.";
